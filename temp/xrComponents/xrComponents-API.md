...
pinch events, pointer rays, optional hand-flight gestures, and triangle
teleport gestures.</p>
</dd>
...
| [options.layout] | <code>object</code> \| <code>false</code> |  | Label layout options. Use `false` or `{ mode: 'offset' }` for raw offsets. |
| [options.layout.mode] | <code>&#x27;split&#x27;</code> \| <code>&#x27;radial&#x27;</code> \| <code>&#x27;offset&#x27;</code> | <code>&#x27;split&#x27;</code> | Automatic distribution strategy. |
...
| [options.waitTimeout] | <code>number</code> | <code>8000</code> | Max milliseconds to wait for usable component anchors. |
...
* [XRTeleportMoveControl](#module_XRTeleportMoveControl)
    * _static_
        * [.XRTeleportMoveControl](#module_XRTeleportMoveControl.XRTeleportMoveControl)
            ...
            * [._updateTeleportGizmo(pos, stickPosition, ray, [surfaceNormal])](#module_XRTeleportMoveControl.XRTeleportMoveControl+_updateTeleportGizmo)
            * [._updateTeleportArc(ray, targetPos)](#module_XRTeleportMoveControl.XRTeleportMoveControl+_updateTeleportArc)
...
#### xrTeleportMoveControl.\_updateTeleportGizmo(pos, stickPosition, ray, [surfaceNormal])
...
#### xrTeleportMoveControl.\_updateTeleportArc(ray, targetPos)
...
| worldContainer | <code>THREE.Group</code> | Scene node the menu panel is attached to. |
| controllersManager | <code>ControllersManager</code> | The shared ControllersManager instance. |
| [options] | <code>object</code> | Options merged with VRMenu defaults.   Additional properties: `rendererScale` (default `2`) and `rendererMode` (default `'commitOnly'`). |
...
Reads canvas and renderer dimensions and updates the mesh aspect ratioso the panel fits the menu exactly without blank space or distortion.
